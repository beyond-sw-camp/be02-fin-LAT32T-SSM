...
public class MessageService {
    ...
    public void updateMessage(String chatRoomId, UpdateMessageReq updateMessageReq) {
        ...
        if (!updateMessageReq.getMessage().isEmpty()) {
            Member member = memberRepository.findByMemberId(updateMessageReq.getMemberId()).orElseThrow(() ->
                    MemberNotFoundException.forMemberId(updateMessageReq.getMemberId()));
