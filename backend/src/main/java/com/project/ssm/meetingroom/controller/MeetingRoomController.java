...
public class MeetingRoomController {
    ...
    public ResponseEntity<BaseResponse> getMeetingRoomDetails(@PathVariable Long roomIdx) {
        MeetingSelectRes details = meetingRoomService.getMeetingRoomDetailsWithReservations(roomIdx);
