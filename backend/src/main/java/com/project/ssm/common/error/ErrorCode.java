...
public enum ErrorCode {
    ...
    // 일정
    EVENT_NOT_FOUND(HttpStatus.NOT_FOUND, "CALENDAR_001", "일정을 찾을 수 없습니다."),
    UNAUTHORIZED_ACCESS_EVENT(HttpStatus.FORBIDDEN, "CALENDAR_002", "권한이 없는 사용자입니다."),
    DUPLICATED_EVENT(HttpStatus.CONFLICT, "CALENDAR_003", "이미 존재하는 일정입니다."),
    INVALID_DATETIME(HttpStatus.BAD_REQUEST, "CALENDAR_004", "등록할 수 없는 시간입니다."),
    EMPTY_INPUT(HttpStatus.BAD_REQUEST, "CALENDAR_005", "필수 입력값을 입력하지 않았습니다."),
    NO_SEARCH_RESULT(HttpStatus.NOT_FOUND, "CALENDAR_006", "검색 결과가 없습니다."),
    ;
