...
public enum ErrorCode {
    ...
    // 회원
    DUPLICATE_SIGNUP_ID(HttpStatus.BAD_REQUEST, "USER_001", "회원 이메일이 중복된 경우"),
    MEMBER_NOT_EXISTS(HttpStatus.NOT_FOUND, "USER_003", "회원을 찾을 수 없는 경우"),
    DIFFERENT_USER_PASSWORD(HttpStatus.BAD_REQUEST, "USER_004", "회원의 패스워드가 저장된 데이터와 다른 경우"),
