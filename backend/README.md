...
* **@Scheduled**
  ...
  * 서버의 부하로 인해 안정적인 서비스 제공이 어렵다고 판단하였다.
  <p align="center">
    <br><img width="30%" src="./img/배치적용전.png"><br>배치 적용 전</p> 
* **Spring Batch**
  1. 역할 분리
     * 기존에 사용했던 @Scheduled 방식에서 벗어나 Job, Step, Tasklet을 통해 역할을 분리하여 각각의 역할에 맞게 구현하였다.
  2. 부하분산
...
> Spring Batch 프로그램을 일정 주기로 k8s 클러스터 내에서 실행하기 위해 스케줄러로 크론 잡을 사용하였다. 
* **Spring Cloud Data Flow**
</details>
